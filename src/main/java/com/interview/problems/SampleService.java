...
public class SampleService {
    ...
    // TODO: return the earliest day (smallest key) if multiple days have the same highest temperature count
    //  example: days 1 and 3 both have the highest temperature of 90 degrees, 1 should be returned
